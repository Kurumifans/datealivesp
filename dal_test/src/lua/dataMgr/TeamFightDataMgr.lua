...
function TeamFightDataMgr:requestJoinTeam( nTeamId,nBattleId,nTeamType,joinType)                    --@nTeamId 将队伍id
    ...
    if self.strTeamId == "" then
        ...
        elseif nTeamType == 3 or nTeamType == 4 or nTeamType == 5  or nTeamType == 6 or nTeamType == 10 then
            self.nTeamType = nTeamType
            self.nBattleId = nBattleId
...
function TeamFightDataMgr:checkInviteMsg(chatInfo,timestamp)
    ...
    elseif nTeamType == 3 or nTeamType == 4 or nTeamType == 5 or nTeamType == 6 or nTeamType == 7 or nTeamType == 8 or nTeamType == 9 or nTeamType == 10 then
    else
