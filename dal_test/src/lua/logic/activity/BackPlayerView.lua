...
function BackPlayerView:initData(selectActivityId)
    ...
    self.createModelClass_ = {
        ...
        [EC_ActivityType2.PLAYER_REGRESS_TASK] = requireNew("lua.logic.activity.playerRegress.PlayerRegressTaskView"),
        [EC_ActivityType2.PLAYER_REGRESS_LOGIN] = requireNew("lua.logic.activity.playerRegress.PlayerRegressLoginView"),
        [EC_ActivityType2.PLAYER_REGRESS_GIFT] = requireNew("lua.logic.activity.playerRegress.PlayerRegressGiftView"),
    }
end
