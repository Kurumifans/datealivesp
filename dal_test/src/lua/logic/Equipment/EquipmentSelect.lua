...
function EquipmentSelect:updateOrgAttr()
    if self.ishave then
       ...
       print("#########2")
        self.old_atk:setString(math.floor(EquipmentDataMgr:getEquipBaseAtk(self.showId)));
        self.old_def:setString(math.floor(EquipmentDataMgr:getEquipBaseDef(self.showId)));
        self.old_hp:setString(math.floor(EquipmentDataMgr:getEquipBaseHp(self.showId))); 
    else
    ...
    if self.isToEquip then
       -- self.old_lv:setString(EquipmentDataMgr:getEquipLv(self.showId)); 
       print("#########2")
        self.old_atk:setString(math.floor(EquipmentDataMgr:getEquipBaseAtk(self.currentId)));
        self.old_def:setString(math.floor(EquipmentDataMgr:getEquipBaseDef(self.currentId)));
        self.old_hp:setString(math.floor(EquipmentDataMgr:getEquipBaseHp(self.currentId))); 
    end
...
function EquipmentSelect:updateEquipInfo()
   ...
   -- self.cur_lv:setString(math.floor(EquipmentDataMgr:getEquipLv(self.currentId))); 
    self.cur_atk:setString(math.floor(EquipmentDataMgr:getEquipBaseAtk(self.currentId)));
    self.cur_def:setString(math.floor(EquipmentDataMgr:getEquipBaseDef(self.currentId)));
    self.cur_hp:setString(math.floor(EquipmentDataMgr:getEquipBaseHp(self.currentId)));

     if self.ishave and EquipmentDataMgr:getEquipBaseAtk(self.currentId) < EquipmentDataMgr:getEquipBaseAtk(self.showId) then
     ...
     elseif self.ishave and EquipmentDataMgr:getEquipBaseAtk(self.currentId) > EquipmentDataMgr:getEquipBaseAtk(self.showId) then
         self.atk_arrow:setVisible(true);
     ...
     if self.ishave and EquipmentDataMgr:getEquipBaseDef(self.currentId) < EquipmentDataMgr:getEquipBaseDef(self.showId) then
     ...
     elseif self.ishave and EquipmentDataMgr:getEquipBaseDef(self.currentId) > EquipmentDataMgr:getEquipBaseDef(self.showId) then
     ...
     if self.ishave and EquipmentDataMgr:getEquipBaseHp(self.currentId) < EquipmentDataMgr:getEquipBaseHp(self.showId) then
     ...
     elseif self.ishave and EquipmentDataMgr:getEquipBaseHp(self.currentId) > EquipmentDataMgr:getEquipBaseHp(self.showId) then
