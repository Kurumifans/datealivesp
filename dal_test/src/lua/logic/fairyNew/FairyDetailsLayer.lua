...
function FairyDetailsLayer:ctor(data)
	...
	self.tabBtnInfo = {
	{name = "属性", icon = "ui/fairy/new_ui/tab_1.png"},
	{name = "结晶", icon = "ui/fairy/new_ui/tab_2.png"},
	{name = "质点", icon = "ui/fairy/new_ui/tab_3.png"},
	{name = "天使", icon = "ui/fairy/new_ui/tab_4.png"},
	{name = "羁绊", icon = "ui/fairy/new_ui/tab_6.png"},
	{name = "宝石", icon = "ui/fairy/new_ui/tab_8.png"},
	{name = "灵装", icon = "ui/fairy/new_ui/tab_5.png"}}
...
function FairyDetailsLayer:updateAngelLayer()
    ...
    Label_angel_level:setText("Lv."..HeroDataMgr:getAngelBreakLevel(self.showHeroId, self.isfriend))
    local angelLv = HeroDataMgr:getAngelLevel(self.showHeroId);
    if angelLv >= 5 then
