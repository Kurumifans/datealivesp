...
--]]
s2c.SNOW_FESTIVAL_RES_PAMPHLET_LEVEL_UP = 9303
...
--]]
s2c.ACTIVITY_RESP_MAKE_FORMULA = 5223
...
--]]
s2c.ACTIVITY_RESP_SPECIAL_MAKE_FORMULA = 5222
...
--]]
s2c.SNOW_FESTIVAL_RES_FINISH_GAME = 9302
...
--]]
s2c.SNOW_FESTIVAL_RES_ENTER_MEMORY = 9301
...
--[[
	[1] = {--BuyMonthCardInfo
		[1] = {--GetMonthCardInfo
			[1] = 'int32':lastGainDate	[上次领取时间]
			[2] = 'int32':surplus_Gain_Count	[剩余领取次数]
			[3] = 'int32':cardCid	[卡cid]
			[4] = {--ChangeType(enum)
				'v4':ChangeType
			},
			[5] = 'int32':etime	[剩余的时间]
