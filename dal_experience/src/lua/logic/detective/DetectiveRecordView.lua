    ...
    for k,v in ipairs(allMainLogInfo) do
        ...
        if cfg then
            if v.finished then
                ...
                TFDirector:getChildByPath(subItem, "Label_title"):setText("【剧情回顾】")
                ...
                TFDirector:getChildByPath(mainItem, "Label_title"):setText("【主线目标】")
...
function DetectiveRecordView:loadInfo()
    ...
    TFDirector:getChildByPath(item2, "Label_title"):setText("体貌特征")
...
function DetectiveRecordView:chooseType(id)
    ...
    local str = id == 1 and "任务目标" or "人物档案"
