...
function DetectiveChapterInfoActivity:initUI( ui )
	...
	local startDataString = Utils:getDateString(self.activityInfo.startTime,1)
	local endDataString = Utils:getDateString(self.activityInfo.endTime,1)
	self.Label_date:setText(startDataString.."-"..endDataString)
end
...
function DetectiveChapterInfoActivity:updateTaskItem( item, data )
	...
	Label_taskDes:setText(itemInfo.extendData.des2)
