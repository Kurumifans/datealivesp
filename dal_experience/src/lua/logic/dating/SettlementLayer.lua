...
function SettlementLayer:initUI(ui)
    ...
    self.Panel_exp = TFDirector:getChildByPath(self.Panel_info,"Panel_exp")
    self.Panel_favor = TFDirector:getChildByPath(self.Panel_info,"Panel_favor")
    self.Panel_mod = TFDirector:getChildByPath(self.Panel_info,"Panel_mod")
