...
function EquipConvert:updateRightEquipInfo()
    ...
    self.hpLabel:setString(math.floor(EquipmentDataMgr:getEquipBaseHp(self.selectId))); 
    self.atkLabel:setString(math.floor(EquipmentDataMgr:getEquipBaseAtk(self.selectId)));
    self.defLabel:setString(math.floor(EquipmentDataMgr:getEquipBaseDef(self.selectId)));
