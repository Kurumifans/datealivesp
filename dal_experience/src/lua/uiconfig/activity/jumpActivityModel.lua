local t = 
{
				...
				
				{
					...
					components = 
					{
						
						{
							...
							sizeType = "0",
							srcBlendFunc = "1",
							texturePath = "ui/activity/activity_bg/007.png",
							touchAble = "False",
							UILayoutViewModel = 
							{
								LeftPositon = 430,
						...
						},
						{
							...
							ignoreSize = "True",
							name = "Button_jump",
							normal = "ui/activity/activity_bg/jumpbutton7.png",
							sizepercentx = "0",
							sizepercenty = "0",
							sizeType = "0",
							srcBlendFunc = "1",
						...
						},
						{
							...
							components = 
							{
								...
								{
									controlID = "act_time_panel_date_Panel_root_Panel-jumpActivityModel_jumpActivityModel_activity_Game",
									UUID = "e3697051_18fd_4913_bf26_64000e4c6aeb",
									anchorPoint = "False",
									anchorPointX = "0.5",
									anchorPointY = "0.5",
									classname = "MELabel",
									...
									components = 
									{
										...
										{
											controlID = "act_timeStart_act_time_panel_date_Panel_root_Panel-jumpActivityModel_jumpActivityModel_activity_Game",
											UUID = "31d555ae_5320_45f5_9574_86f4aff1cd45",
											anchorPoint = "False",
											anchorPointX = "0",
											anchorPointY = "0.5",
											classname = "MELabel",
										...
										{
											controlID = "act_timeEnd_act_time_panel_date_Panel_root_Panel-jumpActivityModel_jumpActivityModel_activity_Game",
											UUID = "0d02946d_23cd_4db8_90f5_d706833b596f",
											anchorPoint = "False",
											anchorPointX = "0",
											anchorPointY = "0.5",
											classname = "MELabel",
	...
	respaths = 
	{
		textures = 
		{
			"ui/activity/activity_bg/007.png",
			"ui/activity/activity_bg/jumpbutton7.png",
		},
		armatures = 
		{
